...
function handleButton(elem) {
  switch (elem.id) {
    case "0":
      rockSamples++;
      document.getElementById("Obj1").innerText = get1+":- " + rockSamples;
      break;
    case "1":
      paperSamples++;
      document.getElementById("Obj2").innerText = get2+":- " + paperSamples;
      break;
    case "2":
      scissorsSamples++;
      document.getElementById("Obj3").innerText = get3+":- " + scissorsSamples;
      break;
    case "3":
      spockSamples++;
      document.getElementById("Obj4").innerText = get4+":- " + spockSamples;
      break;
    ...
    case "4":
      lizardSamples++;
      document.getElementById("Obj5").innerText = get5+":- " + lizardSamples;
      break;
